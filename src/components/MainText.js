...
function MainText() {
  ...
  <div className='main-text parallax-title2'><br></br><p>Visa uppskattning till dina nära och kära genom att skicka en bukett! Vilda säsongsbuketter och lite godbitar inom present och inredning. 
  <br>
  </br>Strauss Blommor ligger på Rosenlundsgatan 32 C på Södermalm i  Stockholm (pendel Södra station/t-bana Mariatorget). </p></div>
  </div>
     </div>
        </div>
    )
