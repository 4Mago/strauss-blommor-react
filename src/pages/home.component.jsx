...
const Home = () => {
	...
	return (
		<div>
			...
			<div>
				<div className='vertical-space-inbetween'></div>
				<div className='POWR-blocker-container'>
					<div className='powr-instagram-feed' id='0ea62b8c_1602840170'></div>
					<div className='POWR-blocker'></div>
				</div>
			</div>
